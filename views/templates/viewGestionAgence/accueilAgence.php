...
<body id="page-top">
    ...
    <div id="wrapper">
      ...
      <tr>
        ...
        <th><a href="#" class="btn btn-info btn-sm"><i class="fa fa-eye"></i>
                                            ...
                                            <th> 
                                            <a href="#" class="btn btn-warning btn-sm editbtn" data-toggle="modal" data-target="#modiClientModal"><i class="fa fa-edit "></i>
                                            </a>
 ...
 <div class="modal fade" id="modiClientModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"s
        ...
        <div class="modal-dialog" style="max-width: 75%;" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">AjouterAgent!</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                        ...
                        <div class="p-5">
                            ...
                            >  
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="date" class="form-control form-control-user" id="DateNaissance"
...
-->
    ...
    <script >
        ...
        $ ( document ). prêt ( fonction  () {
            ...
            $ ( '.editbtn' ). sur ( 'clic' ,  fonction  () {

                $ ( '#modiClientModal' ). modal ( 'afficher' );

                $tr  =  $ ( ceci ). le plus proche ( 'tr' );

                var  données  =  $tr . enfants ( "td" ). carte ( fonction  () {
                    renvoie  $ ( this ). texte ();
                }). obtenir ();

                console . log ( données );

                $ ( '#FirstName' ). val ( données [ 0 ]);
                $ ( '#LastName' ). val ( données [ 1 ]);
                $ ( '#LastName' ). val ( données [ 2 ]);
                $ ( '#LastName' ). val ( données [ 3 ]);
                $ ( '#LastName' ). val ( données [ 4 ]);
            });
        });
    </ script >
