...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="listerAgent.php">Lister Agent</a>
                        <a class="collapse-item" href="listerOperationAgent.php">Lister Operations Agent</a>
                        <a class="collapse-item" href="listerClientAgence.php">Lister Client Agence</a>
    ...
    <div class="modal fade" id="AjouterAgentModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"s
        ...
        <div class="modal-dialog" style="max-width: 75%;" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Creer agent!</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">×</span>
                    </button>
                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="p-4">
                                    ...
                                    <form class="user">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Prenom">
                                        </div>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                        ...
                                        <div class="form-group">
                                            <input type="date" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Date Naissqnce">
                                        </div>
                                        <div class="form-group">
                                            <input type="date" class="form-control form-control-user"
                                        ...
                                        <hr class="sidebar-divider">
                                        <a href="accueilAgence.php" class="btn btn-primary btn-user btn-block">
                                            Valider
                                        </a>
                                    </form>
