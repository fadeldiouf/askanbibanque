<<<<<<< HEAD:views/templates/viewGestionAgence/accueilAgence.php
...
>>>>>>> 0e5a3e06f05cd806f0a543c39937c519f0cfb4de:views/templates/viewGestionAgence/accueilSiege.php
<!DOCTYPE html>
...
<<<<<<< HEAD:views/templates/viewGestionAgence/accueilAgence.php
                                ...
                                <?php  echo  $_SESSION['prenomAuth'] = $prenom . $_SESSION['nomAuth'] = $nom;?> 
                                </span>
=======
...
<<<<<<< HEAD:views/templates/viewGestionAgence/accueilAgence.php
      ...
      <tr>
        ...
        <th><a href="#" class="btn btn-info btn-sm"><i class="fa fa-eye"></i>
                                            ...
                                            <th> 
                                            <a href="#" class="btn btn-warning btn-sm" data-toggle="modal" data-target="#modiClientModal"><i class="fa fa-edit "></i>
                                            </a>
