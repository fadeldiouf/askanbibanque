            ...
            <div id="content">
                ...
                <div class='alert alert-primary w-100 mx-auto py-4 col-md-6  m-auto ml-7'>
                  <form  action="../../../controllers/TransactionContoller.php"  method='POST'> 
                    Numero Compte
                    <input type='text' class='form-control' value="<?php echo  $_SESSION['num_compte']; ?>" class='form-control ' readonly required>
                     Nom
                    ...
                    <button type='submit' name='depot' class='btn btn-primary btn-bloc btn-sm my-1'>Depot</button>
                  </form>
                </div>    
                </div>
                <!-- /.container-fluid -->
